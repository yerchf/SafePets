...
Route::get('showAboutas/show', 'PublicationController@showAboutas')->name('aboutas.show');
Route::get('showContact/show', 'PublicationController@showContact')->name('contact.show');
Route::get('showDistrict/show', 'PublicationController@showDistrict')->name('district.show');